...
Begin VB.Form FRM2HVARIOS2 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "PERDIDAS DE CARGA  EN  PRINCIPAL"
   ClientHeight    =   9645
   ClientLeft      =   30
   ClientTop       =   930
   ClientWidth     =   19110
   ForeColor       =   &H8000000D&
   Icon            =   "FRM2HVARIOS2.frx":0000
   LinkTopic       =   "FRM2HVARIOS2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9645
   ScaleWidth      =   19110
   ...
   Begin VB.ComboBox CBOMANNING 
      ...
      ForeColor       =   &H80000002&
      Height          =   420
      ItemData        =   "FRM2HVARIOS2.frx":0605
      Left            =   4560
      List            =   "FRM2HVARIOS2.frx":0618
      TabIndex        =   73
   ...
   Begin VB.ComboBox CBODARCY 
      ...
      ForeColor       =   &H80000002&
      Height          =   420
      ItemData        =   "FRM2HVARIOS2.frx":0641
      Left            =   120
      List            =   "FRM2HVARIOS2.frx":0657
      TabIndex        =   72
      Text            =   "MATERIAL DE LA TUBERIA"
      Top             =   8520
      Visible         =   0   'False
   ...
   Begin VB.ComboBox Combo1 
      ...
      ForeColor       =   &H00FF0000&
      Height          =   360
      ItemData        =   "FRM2HVARIOS2.frx":06B1
      Left            =   120
      List            =   "FRM2HVARIOS2.frx":06BE
      TabIndex        =   1
      Text            =   "FORMULA"
      Top             =   1080
      Width           =   4215
   ...
   Begin VB.ComboBox CBOHAZEN 
      ...
      ForeColor       =   &H80000002&
      Height          =   420
      ItemData        =   "FRM2HVARIOS2.frx":06ED
      Left            =   120
      List            =   "FRM2HVARIOS2.frx":0703
      TabIndex        =   3
      Text            =   "MATERIAL DE LA TUBERIA"
      Top             =   1560
      Width           =   4215
   ...
   End
End
Attribute VB_Name = "FRM2HVARIOS2"
...
MSFlexGrid1.ColWidth(10) = 1.7 * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(11) = 0 * (MSFlexGrid1.ColWidth(1))
...
If KeyAscii = 13 Then
    If NT > Index + 1 Then
        ...
        If IsNumeric(Text3(i)) Then
                If (Text3(i)) > 1.79 Then
                    
                    Else
                    MsgBox "Ingrese valor mayor o igual que 1.8 m3/hora", 42, "Se acostumbra trabajar con caudales mayores mayores a 1/2 l/seg"
                    Text3(i).Text = ""
                    Text3(i).SetFocus
                    Exit Sub
                End If
