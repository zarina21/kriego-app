VERSION 5.00
Begin VB.Form frmcasosucpositiva2 
   ...
   Begin VB.ComboBox CBOGC 
      ...
      ForeColor       =   &H8000000D&
      Height          =   315
      ItemData        =   "frmcasosucpositiva2.frx":0000
      Left            =   9120
      List            =   "frmcasosucpositiva2.frx":0022
      TabIndex        =   63
      Text            =   "Grados  C"
      Top             =   50
      Visible         =   0   'False
   ...
   Begin VB.TextBox Text9 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   52
      Text            =   "frmcasosucpositiva2.frx":0079
      Top             =   600
      Visible         =   0   'False
      Width           =   8235
   End
   Begin VB.Frame Frame3 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.TextBox Text7 
            ...
            ScrollBars      =   3  'Both
            TabIndex        =   49
            Text            =   "frmcasosucpositiva2.frx":0153
            Top             =   0
            Visible         =   0   'False
            Width           =   12100
         End
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H8000000D&
         Height          =   315
         ItemData        =   "frmcasosucpositiva2.frx":23CC
         Left            =   120
         List            =   "frmcasosucpositiva2.frx":23EE
         TabIndex        =   11
      ...
      Begin VB.Label Label32 
         Caption         =   "DIAMETRO TUBERIA DESCARGA (mm)"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label31 
         Caption         =   "VEL. DESCARGA H20    2.1 a 3 m/s"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmcasosucpositiva2"
...
Rem  SEGURIDAD  BAJA
    ...
    Else
      ...
      If Err Then
            MsgBox " Favor contactar 00-511-974614232 o 00-58-424-583-7719 para Actualizar : goteocania@lamolina.edu.pe."
            Rem Stop
            End
            Exit Sub
            Rem Unload Me
...
If Index = 5 Then
    If IsNumeric(Text3(Index)) Then
        ...
        Else
            MsgBox "NPSH disponible > NPSH requerido * bomba, CAVITACION: Selecciona otra curva de bomba ", 42, " Cuidado :NPSH requerido debe ser <  NPSH disponible, minimo menor 0.50 metro "
            Text3(Index).Text = ""
            Text3(Index).SetFocus
        End If
    Else
...
If Index = 8 Then
    If IsNumeric(Text3(Index)) Then
    Rem Stop
    QW34E = Val(Text3(Index))
    ERTFD4 = Val(Text3(Index - 1))
        Rem If Val((Text3(Index)) < Val(Text3(Index - 1))) Then
        If QW34E < ERTFD4 Then
...
If Index = 9 Then
    If IsNumeric(Text3(Index)) Then
        ...
        If Val(Text3(Index)) > 1000 Then
            ...
            Text3(Index + 2).Visible = True
            Text3(Index + 3).Visible = True
            Rem Stop
            qwas = Val(Text3(0))
            wert = Val(Text3(11))
            numerador = Sqr((Text3(0) / 3.6) / Text3(11))
            If Val(Text3(0)) > 0 Then
                Text3(12) = Format(35.68 * Sqr((Text3(0) / 3.6) / Text3(11)), "###.#")
             Else
                Text3(12) = Format(35.68 * Sqr(Text3(10) / (Text3(11))), "###.#")
             End If
        Else
