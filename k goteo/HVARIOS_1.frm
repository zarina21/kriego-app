...
Begin VB.Form FRMHVARIOS_1 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " PERDIDA DE CARGA  Y  GOLPE DE ARIETE"
   ClientHeight    =   8400
   ClientLeft      =   510
   ClientTop       =   885
   ClientWidth     =   12825
   ForeColor       =   &H8000000D&
   LinkTopic       =   "FRMHVARIOS_1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8400
   ScaleWidth      =   12825
   ...
   End
End
Attribute VB_Name = "FRMHVARIOS_1"
...
MSFlexGrid1.ColWidth(9) = 1# * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(10) = 1.3 * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(11) = 1.5 * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(13) = 6# * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(0) = 0.6 * (MSFlexGrid1.ColWidth(1))
MSFlexGrid1.ColWidth(12) = 0.9 * (MSFlexGrid1.ColWidth(1))
...
If KeyAscii = 13 And (IsNumeric(nt.Text) And Val(nt.Text) > 0) Then
    ...
    For i = 1 To nt
        ...
        MSFlexGrid1.Col = 12
        MSFlexGrid1.Row = i
        MSFlexGrid1.Text = Format$(ga(i), "###.0#")
        MSFlexGrid1.Col = 13
        MSFlexGrid1.Row = i
