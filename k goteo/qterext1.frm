...
Begin VB.Form qTEREXT1 
   ...
   Begin VB.ComboBox Combo2 
      ...
      Left            =   120
      TabIndex        =   59
      Text            =   "                                                                  SELECCIONA LA VALVULA DEL  ARCO DE RIEGO"
      Top             =   7800
      Visible         =   0   'False
      Width           =   9375
   End
   ...
   Begin VB.Label Label29 
      Alignment       =   2  'Center
      Caption         =   "DIAMETRO VALVULA PURGA (pulg)"
      ForeColor       =   &H00FF0000&
      Height          =   495
      Left            =   6600
      TabIndex        =   66
   ...
   Begin VB.Label Label26 
      Alignment       =   2  'Center
      Caption         =   "PERDIDA CARGA EN VALVULA (metros)"
      ForeColor       =   &H00FF0000&
      Height          =   375
      Left            =   120
      TabIndex        =   60
...
Case 0
   Rem Valvula Dorot 3/4"
   HHARCO = 0.4625 * qqtt ^ 1.0526
   Text8 = HHARCO
   Text9 = "3/4"
   Text10 = Format(TEXT32 / 1000, "###.0")
   Text11 = " 1/2"
Case 1
    Rem Valvula Dorot 1"
    HHARCO = 0.3767 * hhtt ^ 1.0376
    Text8 = HHARCO
    Text9 = " 1"
    Text10 = Format(TEXT32 / 1000, "###.0")
    Text11 = " 3/4"
Case 2
    Rem Valvula Dorot 1 1/2"
    HHARCO = 0.2679 * hhtt ^ 0.9147
    Text8 = HHARCO
    Text9 = " 1.5"
    Text10 = Format(TEXT32 / 1000, "###.0")
    Text11 = " 1.0"
...
End Select
Text8 = Format(Text8, "##.0#")
valterd = Text9
valpur = Text11
Rem Combo2.Visible = False
End Sub
...
Rem MODELOS DE VAALVULAS HIDRAULICAS
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 20 mm, 3/4 pul, Qmax=  6 m3/h, Kv=  7.5, Pc= 3 m"
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 25 mm, 1.0 pul, Qmax= 10 m3/h, Kv= 17.5, Pc= 4.5 m"
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 35 mm, 1.5 pul, Qmax= 25 m3/h, Kv=   60, Pc= 5.5 m"
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 50 mm, 2.0 pul, Qmax= 40 m3/h, Kv=   71, Pc= 7.0 m"
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 65 mm, 2.5 pul, Qmax= 65 m3/h, Kv=   79, Pc= 9.0 m"
Combo2.AddItem "VALVULA HIDRAULICA DOROT PLASTICA, SERIE 75-2w, D= 80 mm, 3.0 pul, Qmax= 90 m3/h, Kv=   90, Pc= 7.5 m"
End Sub
